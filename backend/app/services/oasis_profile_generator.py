...
class OasisProfileGenerator:
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """获取系统提示词"""
        base_prompt = "You are a social media user profile generation expert. Generate detailed, realistic personas for opinion simulation, restoring reality as closely as possible. You must return valid JSON format; all string values must not contain unescaped newlines. IMPORTANT: Respond entirely in English only."
        return base_prompt
