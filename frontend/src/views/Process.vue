      ...
      <div class="left-panel" :class="{ 'full-screen': isFullScreen }">
        ...
        <div class="graph-container" ref="graphContainer">
          ...
          <div v-else-if="currentPhase < 1" class="graph-waiting">
            ...
            <p class="waiting-hint">Graph build will start automatically when generation is complete</p>
          </div>
          ...
          <div v-else-if="currentPhase === 1 && !graphData" class="graph-waiting">
            ...
            <p class="waiting-text">Graph Construction in progress</p>
            ...
            <div class="phase-detail">
              <div class="detail-section">
                ...
                <div class="detail-content">
                  After uploading documents, LLM analyzes content and automatically generates an ontology structure suitable for public opinion simulation (Entity Types + Relationship Types)
                </div>
              </div>
          ...
          <div class="process-phase" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
            ...
            <div class="phase-detail">
              <div class="detail-section">
                <div class="detail-label">API Description</div>
                <div class="detail-content">
                  Based on the generated ontology, documents are chunked and passed to the Zep API to build the knowledge graph, extracting entities and relations
                </div>
              </div>
...
const currentPhase = ref(-1) // -1: Uploading, 0: Ontology Generating, 1: Graph Construction, 2: Complete
...
const statusText = computed(() => {
  ...
  if (currentPhase.value === 1) return 'Graph Construction In Progress'
...
const startGraphPolling = () => {
  ...
  // Fetch graph data every 10s automatically
...
const renderGraph = () => {
  ...
  // Draw edges (including transparent wide click area)
  ...
  // Transparent wide line for click interaction
  ...
  simulation.on('tick', () => {
    // Update position of all edges (including transparent click area)
