    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              With just a snippet of text, <span class="highlight-bold">MiroFish</span>  can automatically generate up to <span class="highlight-orange">1 million agents</span> in a parallel world. Inject variables from a god's-eye view to find <span class="highlight-code">"locally optimal solutions"</span>
            </p>
            <p class="slogan-text">
              Let the future rehearse among agents, and let decisions prevail after countless simulations<span class="blinking-cursor">_</span>
            </p>
          </div>
        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            <div class="metric-card">
              ...
              <div class="metric-label">Avg. $5 per typical simulation</div>
            </div>
            <div class="metric-card">
              <div class="metric-value">High Availability</div>
              <div class="metric-label">Up to 1 million agents per simulation</div>
            </div>
          </div>

          <!-- Project Simulation Steps Overview (New Section) -->
            ...
            <div class="console-section">
              ...
              <div class="input-wrapper">
                <textarea
                  ...
                  class="code-input"
                  placeholder="// Describe your simulation or prediction goal in natural language (e.g. If Wuhan University announces the reversal of a disciplinary decision, what public opinion trends would emerge?)"
                  rows="6"
                  :disabled="loading"
                ></textarea>
...
:root {
  ...
  --border: #E5E5E5;
  /*
    Uses Space Grotesk as primary heading font, JetBrains Mono as code/label font
