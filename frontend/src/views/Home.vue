    ...
    <div class="main-content">
      ...
      <section class="hero-section">
        <div class="hero-left">
          ...
          <div class="hero-desc">
            <p>
              With just a snippet of text, <span class="highlight-bold">MiroFish</span>  can automatically generate up to <span class="highlight-orange">1 million agents</span> in a parallel world. Inject variables from a god's-eye view to find <span class="highlight-code">“局部最优解”</span>
            </p>
            <p class="slogan-text">
        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            ...
            <div class="metric-card">
              ...
              <div class="metric-label">最多1 million agents模拟</div>
            </div>
          </div>
            ...
            <div class="console-section">
              ...
              >
                ...
                <div v-if="files.length === 0" class="upload-placeholder">
                  ...
                  <div class="upload-title">拖拽File Upload</div>
