    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM analyzes document content and Simulation Requirement, extracts reality seeds, and automatically generates an appropriate ontology structure
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Based on the generated ontology, documents are automatically chunked and passed to Zep to build the knowledge graph, extracting entities and relations, forming temporal memory and community summaries
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph Construction complete. Please proceed to the next step for simulation Environment Setup.</p>
          <button 
            class="action-btn" 
