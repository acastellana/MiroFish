    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            基于生成的本体，将文档自动分块后调用 Zep 构建知识图谱，提取实体和关系，并形成时序记忆与社区Summary
          </p>
          ...
          <div class="stats-grid">
            ...
            <div class="stat-card">
              ...
              <span class="stat-label">关系Edges</span>
            </div>
            <div class="stat-card">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Graph ConstructionCompleted，请进入Next进行模拟Environment Setup</p>
          <button 
            class="action-btn" 
