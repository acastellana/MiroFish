        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Quick chat version of the report agent. Has access to 4 professional tools and MiroFish's full memory.</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Aligns real-world seed data with simulation state, uses Global/Local Memory to deliver deep cross-temporal attribution analysis.</div>
                  </div>
                </div>
                ...
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG-based instant query interface optimized for quickly extracting specific node attributes and discrete facts.</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Autonomous interviewer that conducts parallel multi-turn conversations with agents, collecting unstructured opinion data and psychological state.</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent to explore report content' : 'Chat with a simulated agent to learn their views' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Enter the question to ask all selected agents..."
                rows="3"
              ></textarea>
            </div>
...
const selectAgent = (agent, idx) => {
  ...
  addLog(`Chat target selected: ${agent.username}`)
}
...
const renderMarkdown = (content) => {
  ...
  // Clean <p><br> followed by block elements
